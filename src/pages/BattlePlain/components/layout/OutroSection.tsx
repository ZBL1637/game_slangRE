...
import bgImage from '../../../../assets/images/2backgroundend.png';
...
export const OutroSection: React.FC<OutroSectionProps> = ({ onComplete, onNextChapter, onRestart }) => {
      ...
      <div className="outro-content">
        ...
        {showButton && (
          <div className="action-buttons">
            {onRestart && (
              <button className="restart-btn" onClick={(e) => { e.stopPropagation(); onRestart(); }}>
                <RotateCcw size={18} />
                重新开始本章
              </button>
            )}
            {onNextChapter && (
              <button className="next-btn" onClick={(e) => { e.stopPropagation(); onNextChapter(); }}>
                前往下一章
                <ArrowRight size={18} />
              </button>
            )}
            <button className="continue-btn" onClick={(e) => { e.stopPropagation(); onComplete(); }}>
              返回世界地图
              <ArrowRight size={18} />
            </button>
          </div>
        ...
        {/* 底部左侧：技能获得通知 */}
        {showButton && (
          <div className="outro-skill-toast">
        ...
        {/* 底部右侧：成就解锁通知 */}
        {showButton && (
          <div className="outro-achievement-toast">
            <div className="toast-content">
              <div className="icon-box">
                <Trophy size={24} />
              </div>
