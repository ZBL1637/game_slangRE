import { DialogueOption, LogSnippet, NetworkLink, NetworkNode, QuizQuestion, SlangNode, SlangTerm } from './types';
...
export const QUIZ_1: QuizQuestion = {
  ...
  wrongHint1: "提示：OT 指的是“Over Threat”，即仇恨失控。",
  wrongHint2: "提示：如果 OT 了，怪物就会转头攻击不该攻击的人。",
  wrongHint3: "答案：选项 C。控制仇恨就是确保怪物攻击正确的目标（通常是坦克）。"
};
